        ...
        try:
            ...
            for id_testcase in test_case_id_list:
                ...
                for _ in range(0, len(list_files_baseline)):
                    ...
                    baseline_actual_hash = Lib.Aux.Main.generate_hash(self, path_file=path_file)

                    Lib.Aux.Main.compare_beyond_compare(self, test_name=test_name, baseline=list_files_baseline[0],
                                                        new_file=list_files_new[0])

                    # Generate a hash for the new baseline file.
                    new_actual_hash = Lib.Aux.Main.generate_hash(self, path_file=path_file)
            ...
            Lib.Aux.Main.delete_directory(self, directory=Lib.Aux.directories['DownloadFolderTemp'])
