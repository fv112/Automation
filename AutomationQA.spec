...
command = Analysis([
            ...
            ('C:\\ProgramData\\QA-Automation-Files\\Repository\\Hash\\en-hash_dictionary.txt','Automation\\Hash'),
            ('C:\\ProgramData\\QA-Automation-Files\\Repository\\Hash\\es-hash_dictionary.txt','Automation\\Hash'),
